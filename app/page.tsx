...
import {
  ...
  Zap, ArrowRight, CheckCircle, Globe, Monitor, Smartphone
} from "lucide-react";
    ...
    <div className="min-h-screen hero-gradient grid-pattern">
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 32px" }}>
        ...
        <div className="text-center" style={{ paddingTop: "80px", paddingBottom: "64px", position: "relative" }}>
          <div className="badge badge-indigo animate-fade-in-up" style={{ marginBottom: "20px", display: "inline-flex" }}>
            <Zap size={11} />
          ...
          >
            <span style={{ color: "white" }}>The Complete</span>
            <br />
          ...
          >
            Merge, split, crop, compress, convert, OCR, scan, sign and print.
            All processing happens <strong style={{ color: "rgba(255,255,255,0.7)" }}>in your browser</strong> — your files never leave your device.
          </p>
        ...
        <div style={{ marginBottom: "80px" }}>
          <h2 style={{ fontSize: "22px", fontWeight: 700, color: "white", marginBottom: "24px" }}>
            All Tools
          </h2>
          <div
            style={{
              ...
              return (
                <Link key={tool.href} href={tool.href} style={{ textDecoration: "none" }}>
                  <div className="tool-card" style={{ height: "100%" }}>
                    ...
                    <div style={{ fontWeight: 600, fontSize: "14px", color: "rgba(255,255,255,0.9)", marginBottom: "6px" }}>
                      {tool.label}
                    </div>
        ...
        >
          <h2 style={{ fontSize: "20px", fontWeight: 700, color: "white", marginBottom: "28px", textAlign: "center" }}>
            Why OmniPDF?
          </h2>
            ...
            {[
              ...
              return (
                <div key={f.title} style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                  ...
                  <div style={{ fontWeight: 600, fontSize: "14px", color: "white" }}>{f.title}</div>
                  <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.4)", lineHeight: 1.6 }}>{f.desc}</div>
                </div>
              );
            })}
          </div>
        ...
        >
          <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.2)", marginTop: "24px" }}>
            OmniPDF Suite — 100% Open Source — MIT License
          </p>
        </div>
      </div>
    </div>
